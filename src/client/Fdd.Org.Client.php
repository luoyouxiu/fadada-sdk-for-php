...
use Lyx\FadadaSdkForPhp\Bean\req\org\CorpChangeIdentityInfoReq;
use Lyx\FadadaSdkForPhp\Bean\req\org\CorpOrganizationManageReq;
use Lyx\FadadaSdkForPhp\Bean\req\org\counterpart\CounterpartListReq;
use Lyx\FadadaSdkForPhp\Bean\req\org\department\DeptCreateReq;
use Lyx\FadadaSdkForPhp\Bean\req\org\department\DeptDeleteReq;
use Lyx\FadadaSdkForPhp\Bean\req\org\department\DeptGetDetailReq;
use Lyx\FadadaSdkForPhp\Bean\req\org\department\DeptGetListReq;
use Lyx\FadadaSdkForPhp\Bean\req\org\department\DeptModifyReq;
use Lyx\FadadaSdkForPhp\Bean\req\org\GetCorpEntityListReq;
use Lyx\FadadaSdkForPhp\Bean\req\org\GetCorpEntityManageUrlReq;
use Lyx\FadadaSdkForPhp\Bean\req\org\member\MemberSetStatusReq;
use Lyx\FadadaSdkForPhp\Bean\req\org\member\MemberCreateReq;
use Lyx\FadadaSdkForPhp\Bean\req\org\member\MemberDeleteReq;
use Lyx\FadadaSdkForPhp\Bean\req\org\member\MemberGetActiveUrlReq;
use Lyx\FadadaSdkForPhp\Bean\req\org\member\MemberGetDetailReq;
use Lyx\FadadaSdkForPhp\Bean\req\org\member\MemberGetListReq;
use Lyx\FadadaSdkForPhp\Bean\req\org\member\MemberModifyReq;
use Lyx\FadadaSdkForPhp\Bean\req\org\member\MemberSetDeptReq;
