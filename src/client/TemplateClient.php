...
use LuoYouXiu\FadadaSdkForPhp\Bean\req\template\corpField\GetCorpFieldListReq;
use LuoYouXiu\FadadaSdkForPhp\Bean\req\template\docTemplate\FillValueDocTemplateReq;
use LuoYouXiu\FadadaSdkForPhp\Bean\req\template\docTemplate\GetDocTemplateListReq;
use LuoYouXiu\FadadaSdkForPhp\Bean\req\template\signTemplate\GetSignTemplateListReq;
use LuoYouXiu\FadadaSdkForPhp\Bean\req\template\corpField\CreateCorpFieldReq;
use LuoYouXiu\FadadaSdkForPhp\Bean\req\template\corpField\DeleteCorpFieldReq;
use LuoYouXiu\FadadaSdkForPhp\Bean\req\template\docTemplate\CopyCreateDocTemplateReq;
use LuoYouXiu\FadadaSdkForPhp\Bean\req\template\docTemplate\CreateDocTemplateReq;
use LuoYouXiu\FadadaSdkForPhp\Bean\req\template\docTemplate\DeleteDocTemplateReq;
use LuoYouXiu\FadadaSdkForPhp\Bean\req\template\docTemplate\DocTemplateDetailReq;
use LuoYouXiu\FadadaSdkForPhp\Bean\req\template\docTemplate\SetDocTemplateStatusReq;
use LuoYouXiu\FadadaSdkForPhp\Bean\req\template\signTemplate\DeleteSignTemplateReq;
use LuoYouXiu\FadadaSdkForPhp\Bean\req\template\signTemplate\SetSignTemplateStatusReq;
use LuoYouXiu\FadadaSdkForPhp\Bean\req\template\signTemplate\SignTemplateDetailReq;
use LuoYouXiu\FadadaSdkForPhp\Bean\req\template\TemplateCreateGetUrl;
use LuoYouXiu\FadadaSdkForPhp\Bean\req\template\TemplateEditGetUrl;
use LuoYouXiu\FadadaSdkForPhp\Bean\req\template\TemplateManageGetUrl;
use LuoYouXiu\FadadaSdkForPhp\Bean\req\template\TemplatePreviewGetUrl;
