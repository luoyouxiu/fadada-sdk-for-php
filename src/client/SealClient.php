...
use LuoYouXiu\FadadaSdkForPhp\Bean\req\seal\CancelPersonalSealFreeSignReq;
use LuoYouXiu\FadadaSdkForPhp\Bean\req\seal\CancelSealFreeSignReq;
use LuoYouXiu\FadadaSdkForPhp\Bean\req\seal\CreateLegalRepresentativeSealByImageReq;
use LuoYouXiu\FadadaSdkForPhp\Bean\req\seal\CreateLegalRepresentativeSealByTemplateReq;
use LuoYouXiu\FadadaSdkForPhp\Bean\req\seal\CreatePersonalSealByImageReq;
use LuoYouXiu\FadadaSdkForPhp\Bean\req\seal\CreatePersonalSealByTemplateReq;
use LuoYouXiu\FadadaSdkForPhp\Bean\req\seal\CreateSealByImageReq;
use LuoYouXiu\FadadaSdkForPhp\Bean\req\seal\CreateSealByTemplateReq;
use LuoYouXiu\FadadaSdkForPhp\Bean\req\seal\GetAppointedSealUrlReq;
use LuoYouXiu\FadadaSdkForPhp\Bean\req\seal\GetAppointedUserSealListReq;
use LuoYouXiu\FadadaSdkForPhp\Bean\req\seal\GetPersonalSealCreateUrlReq;
use LuoYouXiu\FadadaSdkForPhp\Bean\req\seal\GetPersonalSealFreeSignUrlReq;
use LuoYouXiu\FadadaSdkForPhp\Bean\req\seal\GetPersonalSealListReq;
use LuoYouXiu\FadadaSdkForPhp\Bean\req\seal\GetPersonalSealManageUrlReq;
use LuoYouXiu\FadadaSdkForPhp\Bean\req\seal\GetSealCreateUrlReq;
use LuoYouXiu\FadadaSdkForPhp\Bean\req\seal\GetSealDetailReq;
use LuoYouXiu\FadadaSdkForPhp\Bean\req\seal\GetSealFreeSignUrlReq;
use LuoYouXiu\FadadaSdkForPhp\Bean\req\seal\GetSealGrantUrlReq;
use LuoYouXiu\FadadaSdkForPhp\Bean\req\seal\GetSealListReq;
use LuoYouXiu\FadadaSdkForPhp\Bean\req\seal\GetSealManageUrlReq;
use LuoYouXiu\FadadaSdkForPhp\Bean\req\seal\GetSealTagListReq;
use LuoYouXiu\FadadaSdkForPhp\Bean\req\seal\GetSealUserListReq;
use LuoYouXiu\FadadaSdkForPhp\Bean\req\seal\GetVerifySealListReq;
use LuoYouXiu\FadadaSdkForPhp\Bean\req\seal\PersonalSealDeleteReq;
use LuoYouXiu\FadadaSdkForPhp\Bean\req\seal\SealDeleteReq;
use LuoYouXiu\FadadaSdkForPhp\Bean\req\seal\SealGrantCancelReq;
use LuoYouXiu\FadadaSdkForPhp\Bean\req\seal\SealModifyReq;
